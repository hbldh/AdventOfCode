...
import os
import importlib
from AOC2020 import run_solver


def main(which_days):
    for day in which_days:
        try:
            day_module = importlib.import_module("day{0:02d}".format(day), "AOC2020")
        except:
            continue
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Advent of Code AOC2020 - hbldh")
    parser.add_argument(
